    ...
    <form:form action="${context}/book/regist" method="post" enctype="multipart/form-data" modelAttribute="bookRegistForm">
        ...
        <div class="row">
            <div class="input-field col s6">
                ...
                <form:textarea path="title" name="title" id="icon_prefix1" class="materialize-textarea" />
        ...
        <div class="row">
            <div class="input-field col s6">
                <i class="material-icons prefix">mode_edit</i>
                <form:textarea path="info" name="info" id="icon_prefix3" class="materialize-textarea" />
                <form:errors path="info" />
                <label for="icon_prefix3">Info</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s6">
